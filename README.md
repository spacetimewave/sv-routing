...
A declarative Svelte5 routing library with SSR support. 

[sv-routing][npm-url] is built upon the deprecated [svelte-routing][npm-legacy-url] library and preserves the same API to ensure backward compatibility.

View all new and legacy changes via our new [CHANGELOG][changelog-url].
...
<!-- App.svelte -->
<script>
  import { Router, Link, Route } from "sv-routing";
...
[npm]: https://img.shields.io/npm/v/sv-routing.svg
[npm-url]: https://npmjs.com/package/sv-routing
[npm-legacy-url]: https://npmjs.com/package/svelte-routing
[changelog-url]: https://github.com/spacetimewave/sv-routing/blob/master/CHANGELOG.md
